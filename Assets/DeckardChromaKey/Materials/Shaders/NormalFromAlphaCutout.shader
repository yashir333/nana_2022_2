	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 lerpResult24 = lerp( packedInput.ase_texcoord5.xy , appendResult22 , _ScreenSpace);
				float4 tex2DNode13 = tex2D( _MainTex, lerpResult24 );
				...
				float Directions2 = _Directions;
				float Quality2 = _Quality;
				float Size2 = _Size;
				float2 iResolution2 = float2( 1,1 );
				float2 UV02 = lerpResult24;
				...
				float3 staticSwitch26 = worldToTangentDir42_g2;
				#else
				float3 staticSwitch26 = float3(0,0,1);
				#endif
				
				surfaceDescription.Albedo = temp_output_18_0.rgb;
				surfaceDescription.Normal = staticSwitch26;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 appendResult22 = (float2(ase_screenPosNorm.x , ase_screenPosNorm.y));
				float2 lerpResult24 = lerp( packedInput.ase_texcoord.xy , appendResult22 , _ScreenSpace);
				float4 tex2DNode13 = tex2D( _MainTex, lerpResult24 );
				float4 temp_output_18_0 = ( tex2DNode13 * _multiplyIntensity );
		...
		Pass
		{
					...
					)
			{
				...
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 appendResult22 = (float2(ase_screenPosNorm.x , ase_screenPosNorm.y));
				float2 lerpResult24 = lerp( packedInput.ase_texcoord1.xy , appendResult22 , _ScreenSpace);
				float4 tex2DNode13 = tex2D( _MainTex, lerpResult24 );
		...
		Pass
		{
					...
					)
			{
				...
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 appendResult22 = (float2(ase_screenPosNorm.x , ase_screenPosNorm.y));
				float2 lerpResult24 = lerp( packedInput.ase_texcoord3.xy , appendResult22 , _ScreenSpace);
				float2 UV02 = lerpResult24;
				float4 Col2 = float4( 0,0,0,0 );
				float4 localGaussianBlur2 = GaussianBlur2( tex2 , Directions2 , Quality2 , Size2 , iResolution2 , UV02 , Col2 );
				float4 break10 = Col2;
		...
		Pass
		{
				...
				)
			{
				...
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 appendResult22 = (float2(ase_screenPosNorm.x , ase_screenPosNorm.y));
				float2 lerpResult24 = lerp( packedInput.ase_texcoord7.xy , appendResult22 , _ScreenSpace);
				float4 tex2DNode13 = tex2D( _MainTex, lerpResult24 );
				float4 temp_output_18_0 = ( tex2DNode13 * _multiplyIntensity );
...
/*ASEBEGIN
Version=18801
196;676;1408;559;-307.8783;60.98372;1;True;True
Node;AmplifyShaderEditor.ScreenPosInputsNode;21;-710.8787,-444.9404;Float;False;0;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexCoordVertexDataNode;23;-766.8788,-294.5405;Inherit;False;0;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;22;-434.0789,-409.7405;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-782.8788,-131.3404;Inherit;False;Property;_ScreenSpace;ScreenSpace;8;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;24;-243.679,-328.1404;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4;-478.1972,242.0291;Inherit;False;Property;_Quality;Quality;2;1;[IntRange];Create;True;0;0;0;False;0;False;0;8;1;50;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;3;-433.8441,140.2047;Inherit;False;Property;_Directions;Directions;1;1;[IntRange];Create;True;0;0;0;False;0;False;0;16;1;50;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;1;-514.3084,-79.1469;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;None;;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;16;525.9216,60.65993;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.3333333;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;13;15.09195,-246.347;Inherit;True;Property;_TextureSample0;Texture Sample 0;6;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;9;246.6918,509.2534;Inherit;False;Normal From Height;-1;;2;1942fe2c5f1a1f94881a33d532e4afeb;0;2;20;FLOAT;0;False;110;FLOAT;1;False;2;FLOAT3;40;FLOAT3;0
Node;AmplifyShaderEditor.Vector3Node;27;325.1204,280.6599;Inherit;False;Constant;_Vector1;Vector 0;10;0;Create;True;0;0;0;False;0;False;0,0,1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;19;347.5213,-85.74006;Inherit;False;Property;_multiplyIntensity;multiplyIntensity;7;0;Create;True;0;0;0;False;0;False;0;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;39;544.3198,483.0598;Inherit;False;Property;_Metallic;Metallic;10;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;40;549.1201,603.0598;Inherit;False;Property;_Smoothness;Smoothness;11;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;18;557.1215,-135.3401;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.StaticSwitch;26;513.921,320.6598;Inherit;False;Property;_CreateNormals;CreateNormals;9;0;Create;True;0;0;0;False;0;False;0;0;1;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
WireConnection;26;0;9;40
WireConnection;28;0;18;0
WireConnection;28;1;26;0
WireConnection;28;6;18;0
WireConnection;28;7;40;0
WireConnection;28;9;13;4
ASEEND*/
//CHKSM=182EE86C5C9FB826FCCE429AE9FFCF7FE72A62D8