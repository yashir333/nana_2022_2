...
Shader "StandardDeckardChroma"
{
	Properties
	{
		...
		[ASEEnd]_displace("displace", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 uv_NormalMap = inputMesh.ase_texcoord.xy * _NormalMap_ST.xy + _NormalMap_ST.zw;
				float4 tex2DNode14 = tex2Dlod( _NormalMap, float4( uv_NormalMap, 0, 0.0) );
				float3 appendResult16 = (float3(1.0 , 1.0 , tex2DNode14.a));
				...
				#endif
				float3 vertexValue = ( _displace * appendResult16 );
						...
						)
			{
				...
				float4 tex2DNode12 = tex2D( _BaseColorMap, uv_BaseColorMap );
				
				float2 uv_NormalMap = packedInput.ase_texcoord5.xy * _NormalMap_ST.xy + _NormalMap_ST.zw;
				float4 tex2DNode14 = tex2D( _NormalMap, uv_NormalMap );
				
				surfaceDescription.Albedo = tex2DNode12.rgb;
				surfaceDescription.Normal = tex2DNode14.rgb;
				...
				surfaceDescription.Emission = tex2DNode12.rgb;
				surfaceDescription.Smoothness = 0.5;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = tex2DNode12.a;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float2 uv_NormalMap = inputMesh.uv0.xy * _NormalMap_ST.xy + _NormalMap_ST.zw;
				float4 tex2DNode14 = tex2Dlod( _NormalMap, float4( uv_NormalMap, 0, 0.0) );
				float3 appendResult16 = (float3(1.0 , 1.0 , tex2DNode14.a));
...
/*ASEBEGIN
Version=18809
13;595;1360;645;891.3087;-32.13666;1;True;True
Node;AmplifyShaderEditor.TexturePropertyNode;13;-759,180.5;Inherit;True;Property;_NormalMap;_NormalMap;1;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SamplerNode;14;-473,157.5;Inherit;True;Property;_TextureSample1;Texture Sample 0;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;17;-419,357.5;Inherit;False;Property;_displace;displace;2;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;16;-395,503.5;Inherit;False;FLOAT3;4;0;FLOAT;1;False;1;FLOAT;1;False;2;FLOAT;1;False;3;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TexturePropertyNode;11;-669,-82.5;Inherit;True;Property;_BaseColorMap;_BaseColorMap;0;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SamplerNode;12;-442,-79.5;Inherit;True;Property;_TextureSample0;Texture Sample 0;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-175,406.5;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=9B3D3079093DF056FABBDF54E309E9D29C724E7E