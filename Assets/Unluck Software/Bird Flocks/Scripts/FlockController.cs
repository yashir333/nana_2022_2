...
public class FlockController :MonoBehaviour
{
	...
	public int _updateDivisor = 2;              // NO LONGER USED  // Skip update every N frames (Higher numbers might give choppy results, 3 - 4 on 60fps , 2 - 3 on 30 fps)
	...
	public void Update()
	{
		if (_activeChildren > 0)
		{
			if (_skipFrame)
			{
				...
				_newDelta = Time.deltaTime *2 % 0.5f;
			} else
			{
	...
	public void OnDrawGizmos()
	{
		...
		{
			if (_roamers.Count > 0) _roamers.Clear();
