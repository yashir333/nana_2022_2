...
namespace BeautifyHDRP {
    ...
    sealed class BeautifyEditor : VolumeComponentEditor {
        ...
        SerializedDataParameter intensity, compareMode, compareLineAngle, compareLineWidth, compareSameSide, comparePanning;
        ...
        SerializedDataParameter saturate, brightness, contrast, hardlightIntensity, hardlightBlend, daltonize;
        SerializedDataParameter lut, lutIntensity;
        ...
        SerializedDataParameter blurIntensity;
        ...
        public override void OnEnable() {
            ...
            blurIntensity = Unpack(o.Find(x => x.blurIntensity));
        }
        ...
        public override void OnInspectorGUI() {
            ...
            if (lut.overrideState.boolValue) {
                ...
                EditorGUI.indentLevel++;
                Texture lutTex = (Texture)lut.value.objectReferenceValue;
                if (lutTex is Texture2D) {
                    CheckLUTSettings((Texture2D)lutTex);
                }
            ...
            PropertyField(blurIntensity, new GUIContent("Blur Intensity"));
        ...
        void ImportCubeLUT() {
            ...
            Texture tex = CubeLUTImporter.Import(path);
            if (tex != null) {
