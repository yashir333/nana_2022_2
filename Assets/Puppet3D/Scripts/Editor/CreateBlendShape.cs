	...
	public class CreateBlendShape : MonoBehaviour
	{
		static public void MakeBlendShape()
		{
			...
			if (sel != null && sel.GetComponent<SkinnedMeshRenderer>()!= null)
			{
				...
				newBlendShape.transform.position = sel.transform.position;
				newBlendShape.transform.localScale = sel.transform.localScale;
				newBlendShape.transform.rotation = sel.transform.rotation;
