...
namespace Puppet3D
{
	public class CreateControls : Editor
	{
		...
		public static void IKCreateTool(bool worldSpace = false, bool IKFK = true, float DefaultSize = 1.5f)
		{
			...
			poleVectorParent.transform.position = bone.transform.parent.position +  20f*dirPole;
		...
		public static void CreateParentControlMunu()
		{
			CreateParentControl();
		}
		...
		public static void CreateOrientControlMenu()
		{
			CreateOrientControl();
		}
